    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Answers List</h4>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="example3" class="w-100">
                        ...
                        <tbody>
                            <tr>
                                <td><img class="rounded-circle" width="35" src="<?php echo e(asset('/assets/admin/images/profile/17.jpg')); ?>" alt=""></td>
                                <td>Tiger Nixon</td>
                                <td>Architect</td>
                                <td>Male</td>
                                <td>M.COM., P.H.D.</td>
...
<?php echo $__env->make('layouts.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\E COM BUYER\OneDrive\Documents\GitHub\JobsHubV2\resources\views\admin\answers.blade.php ENDPATH**/ ?>