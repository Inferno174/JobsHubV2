            ...
            <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                ...
                <div class="content-single">
                    ...
                    <p>
                        ...
                        productive
                        and healthy enterprises in a world of digital and remote everything, constantly changing
                        work
                    ...
                    <p>
                        ...
                        experiences in
                        working with numerous different design platforms such as digital and print forms.
                    </p>
                ...
                <div class="single-apply-jobs">
                    <div class="row align-items-center">
                        <div class="col-md-5">
                            <a href="<?php echo e(route('users.applyjob')); ?>" class="btn btn-default mr-15">Apply now</a>
                        ...
                        <div class="card-job hover-up wow animate__animated animate__fadeInUp">
                            <div class="card-job-top">
                                ...
                                <div class="card-job-top--info">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7">
                                            <a href="employers-grid.html"><span class="card-job-top--company">AliStudio, Inc</span></a>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 col-12 pl-40 pl-lg-15 mt-lg-30">
                <div class="sidebar-shadow">
                    ...
                    <div class="text-start mt-20">
                        <a href="<?php echo e(route('users.applyjob')); ?>" class="btn btn-default mr-10">Apply now</a>
                        <a href="#" class="btn btn-border">Save job</a>
                    </div>
...
<?php echo $__env->make('layouts.userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\E COM BUYER\OneDrive\Documents\GitHub\JobsHubV2\resources\views/users/blogpreview.blade.php ENDPATH**/ ?>