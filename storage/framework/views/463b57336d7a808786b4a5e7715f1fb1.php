                ...
                <div class="post-listing">
                    <div class="card-blog-1 mb-30 post-list hover-up wow animate__animated animate__fadeIn" data-wow-delay=".0s">
                        <figure class="post-thumb">
                            <a href="<?php echo e(route('users.blogpreview')); ?>">
                                <img alt="jobhub" src="assets/imgs/blog/thumb-1.png">
                            </a>
                        </figure>
                        <div class="card-block-info">
                            <h3 class="post-title mb-15"><a href="<?php echo e(route('users.blogpreview')); ?>">21 Job Interview Tips: How To Make a Great Impression</a></h3>
                            ...
                            <div class="card-2-bottom mt-30">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="keep-reading">
                                        <a href="<?php echo e(route('users.blogpreview')); ?>" class="btn btn-border btn-brand-hover">Keep reading</a>
                                    </div>
                    ...
                    <div class="card-blog-1 mb-30 post-list hover-up wow animate__animated animate__fadeIn" data-wow-delay=".0s">
                        ...
                        <div class="card-block-info">
                            <h3 class="post-title mb-15"><a href="<?php echo e(route('users.blogpreview')); ?>">Leveraging Job Rejection as a Catalyst for Growth</a></h3>
                            <div class="post-meta text-muted d-flex align-items-center mb-15">
                                <div class="author d-flex align-items-center mr-30">
...
<?php echo $__env->make('layouts.userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\E COM BUYER\OneDrive\Documents\GitHub\JobsHubV2\resources\views\users\blogs.blade.php ENDPATH**/ ?>