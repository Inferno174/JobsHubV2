...
<!-- Mirrored from qerza.dexignzone.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 07:17:03 GMT -->
<head>
    <!-- Title -->
    ...
    <link href="<?php echo e(asset('assets/admin/vendor/bootstrap-select/dist/css/bootstrap-select.min.css')); ?>" rel="stylesheet">
	<link href="<?php echo e(asset('assets/admin/vendor/owl-carousel/owl.carousel.css')); ?>" rel="stylesheet">
...
<body>
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="<?php echo e(asset('assets/admin/images/avatar/1.jpg')); ?>" class="rounded-circle user_img" alt="">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="<?php echo e(asset('assets/admin/images/avatar/2.jpg')); ?>" class="rounded-circle user_img" alt="">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="<?php echo e(asset('assets/admin/images/avatar/3.jpg')); ?>" class="rounded-circle user_img" alt="">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="<?php echo e(asset('assets/admin/images/avatar/4.jpg')); ?>" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="<?php echo e(asset('assets/admin/images/avatar/5.jpg')); ?>" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="<?php echo e(asset('assets/admin/assets/admin/images/avatar/4.jpg')); ?>" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="<?php echo e(asset('assets/admin/images/avatar/1.jpg')); ?>" class="rounded-circle user_img_msg" alt="">
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
								<img src="<?php echo e(asset('assets/admin/images/avatar/2.jpg')); ?>" class="rounded-circle user_img_msg" alt="">
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
                        ...
                        <ul class="navbar-nav header-right">
											...
											<li>
												<div class="timeline-panel">
													<div class="media me-2">
														<img alt="image" width="50" src="<?php echo e(asset('assets/admin/images/avatar/1.jpg')); ?>">
													</div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-bs-toggle="dropdown">
                                    ...
                                    <img src="<?php echo e(asset('assets/admin/images/profile/17.jpg')); ?>" width="20" alt="">
                                </a>
                                <div class="dropdown-menu dropdown-menu-end">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="" href="<?php echo e(route('admin.dashboard')); ?>" aria-expanded="false">
							<i class="flaticon-381-networking"></i>
							<span class="nav-text">Dashboard</span>
						</a>
                        
                    </li>
                    <li><a class="" href="<?php echo e(route('admin.jobcategory')); ?>" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">Job Category</span>
						</a>
                        
                    </li>
                    <li><a class="" href="<?php echo e(route('admin.blog')); ?>" aria-expanded="false">
                    ...
                    <li><a class="" href="<?php echo e(route('admin.forms')); ?>" aria-expanded="false">
                    ...
                    <li><a class="" href="<?php echo e(route('admin.questions')); ?>" aria-expanded="false">
							<i class="flaticon-381-heart"></i>
							<span class="nav-text">Questions</span>
						</a>
                        
                    </li>
                    <li><a href="<?php echo e(route('admin.answers')); ?>" class="ai-icon" aria-expanded="false">
    ...
    ***********************************-->
    ...
    <!-- Required vendors -->
     <script src="<?php echo e(asset('assets/admin/vendor/global/global.min.js')); ?>"></script>
	<script src="<?php echo e(asset('assets/admin/vendor/bootstrap-select/dist/js/bootstrap-select.min.js')); ?>"></script>
	<script src="<?php echo e(asset('assets/admin/vendor/chart-js/chart.bundle.min.js')); ?>"></script>
	<script src="<?php echo e(asset('assets/admin/vendor/owl-carousel/owl.carousel.js')); ?>"></script>

	<!-- Chart piety plugin files -->
    <script src="<?php echo e(asset('assets/admin/vendor/peity/jquery.peity.min.js')); ?>"></script>
       <!-- Datatable -->


	<!-- Apex Chart -->
	<script src="<?php echo e(asset('assets/admin/vendor/apexchart/apexchart.js')); ?>"></script>

	<!-- Dashboard 1 -->
	<script src="<?php echo e(asset('assets/admin/js/dashboard/dashboard-1.js')); ?>"></script>
	<script src="<?php echo e(asset('assets/admin/js/custom.min.js')); ?>"></script>
	<script src="<?php echo e(asset('assets/admin/js/deznav-init.js')); ?>"></script>
...
<?php /**PATH C:\Users\E COM BUYER\OneDrive\Documents\GitHub\JobsHubV2\resources\views/layouts/adminlayout.blade.php ENDPATH**/ ?>