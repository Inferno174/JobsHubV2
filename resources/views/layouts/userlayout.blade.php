            ...
            <div class="main-header">
                <div class="header-left">
                    ...
                    <div class="header-nav">
                        <nav class="nav-main-menu d-none d-xl-block">
                            <ul class="main-menu">
                                <li class="">
                                    <a class="active" href="{{route('users.home')}}">Home</a>
                                </li>
                                <li class="">
                                    <a href="{{route('users.jobs')}}">Browse Jobs</a>
                                </li>
                                <li class="">
                                ...
                                <li class="">
                                    ...
                                    {{-- <ul class="sub-menu">
                                        <li><a href="{{route('users.services')}}">Our services</a></li>
                                    </ul> --}}
                                </li>
                                <li class="">
                ...
                <div class="header-right">
                    <div class="block-signin">
                        <a href="{{ route('users.blogs') }}" class="text-link-bd-btom hover-up">Apply Now</a>
                    ...
                    <div class="mobile-menu-wrap mobile-header-border">
                        ...
                        <nav>
                            <ul class="mobile-menu font-heading">
                                ...
                                <li class="">
                                    <a href="{{route('users.blogs')}}">Job blog</a>
                                </li>
                                <li class="">
                                    <a href="{{route('users.aboutus')}}">About us</a>
                                </li>
